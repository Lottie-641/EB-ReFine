log = {
        ...
        'wastewater': {'event_attribute': ['activity', 'timesincecasestart'], 'trace_attribute': [],
                     'event_template': '{{activity}} was performed {{timesincecasestart}} seconds ago from the beginning of the trace.',
                     'trace_template': 'no', 'target':'activity'}
